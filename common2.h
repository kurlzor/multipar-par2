...
#define MAX_CPU			18			// 最大 CPU/Core 個数 (スレッド本数)
...
typedef struct {	// 72バイト
	...
	// ファイルの状態 0=完全, 1=消失, 2=破損, 16=追加, 32=消失して別名&移動, 40=破損して別名&移動
